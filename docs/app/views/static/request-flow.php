...
<ol>
    ...
    <li>Dispatching. Routes are checked from newest to oldest, first from last defined module to first, then from
        default config. Some modules uses default routing, so they can be executed as latest ones.
    </li>
    <li>Controller is created, and action is called.</li>
    <li>Finalizing. Response is getting <code>status</code>, <code>headers</code> and <code>body</code> which is
        returned as script output.
    </li>
</ol>
</p>
